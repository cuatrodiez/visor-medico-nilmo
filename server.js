...
async function getFilesInFolder(folderId) {
    ...
    do {
        let url = `${DRIVE_API}/files?q='${folderId}'+in+parents+and+trashed=false&fields=nextPageToken,files(id,name,mimeType)&key=${GOOGLE_API_KEY}&supportsAllDrives=true&includeItemsFromAllDrives=true&corpora=allDrives&pageSize=1000`;
